...
public interface StoreMessageMapper extends BaseMapper<StoreMessage> {
     ...
     * @return 店铺消息分页
     */
    @Select("select me.title,me.content,me.create_time,sp.store_name,sp.store_id,sp.id,sp.status from sg_message me inner join sg_store_message sp on me.id = sp.message_id ${ew.customSqlSegment} ")
